...
export default function UpdateSubscriptionDialog({ active, onClose = () => ({}) }: HelperDialogProps) {
                ...
                return (
                    <div className="flex items-center flex-col">
                        <div className="flex flex-col items-center max-w-md text-center">
                            ...
                            ) : previousSubscriptionPlanName !== FREE_SUBSCRIPTION_PLAN && currentSubscription?.subscriptionPlan === PREMIUM_UNLIMITED_SUBSCRIPTION_PLAN ? (
                                "You've just unlocked the ultimate storytelling experience! A huge welcome to StoryKasa Premium Unlimited - where your journey into the limitless realms of imagination knows no bounds."
    ...
    return (
        ...
        fullScreen={onMobile}
        active={active}
        maxWidth={currentStep === CHOOSE_SUBSCRIPTION_PLAN_STEP ? "lg" : "sm"}
