    ...
    <div>
      <div>
        ...
        <div className="mt-4 flex items-center">
          ...
          />
          <label className="ml-2 font-semibold text-base">
        ...
        <div className="flex flex-col mt-4">
          ...
          {story?.language && (
            <div className="flex items-center mt-2">
              <GlobeSimple size={20} />
              <label className="ml-2">{story?.language}</label>
            </div>
          )}
          ...
          {story?.playCount ? (
            <div className="flex items-center mt-2">
              ...
              <label className="ml-2">{story?.playCount} plays</label>
            </div>
          ) : null}
        </div>
        {!story?.recordingUrl && (
          <div className="inline-flex py-2 px-3 bg-[#eaf8b2] rounded-2xl mt-4">
            <label className="text-xs">
              Available only for <span className="font-semibold">Premium</span> accounts
            </label>
          </div>
        )}

        {
          ...
          story?.illustrationsURL?.length > 0 ? (
            ...
            <div
              key={story?.recordingUrl}
              className={`mt-6 ${story?.recordingUrl ? "" : "disabled"}`}
            >
              <STKAudioPlayer
                outlined
                src={story?.recordingUrl || ""}
